      ...
      <div className="w-full max-w-md bg-white/10 backdrop-blur-sm rounded-lg shadow-xl overflow-hidden">
        ...
        {status === "success" && (
          <div className="p-8 flex flex-col items-center">
            ...
            <Link
              to="/login"
              className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-medium py-3 px-4 rounded-md transition-all duration-300 text-center"
            >
              Go to Login
            </Link>
          </div>
